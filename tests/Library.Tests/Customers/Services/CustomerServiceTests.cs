...
public class CustomerServiceTests
{
    ...
    [Fact]
    public async Task CreateCustomerAsyncWithInvalidCompanyCreateCustomer()
    {
    ...
    [Fact]
    public async Task CreateCustomerAsyncWithNonExistentCompanyThrowsCompanyNotFoundException()
    {
        // Arrange
        var company = new Company("Acme Corp");
        var creditLimit = new Money(1000, "EUR");
